...
class NeoPatterns : public Adafruit_NeoPixel
{
  public:
    ...
    */
    ...
    const uint8_t CyclotronLEDs = 50; // Changed for Ben's Pack (48 - 97)
    const uint8_t PowerCellLEDs = 16; // (16 - 38)
    const uint8_t HGALEDs = 7; // Changed for Ben's Pack (0 - 6) // new
    const uint8_t BoosterLEDs = 16; // Changed for Ben's Pack (7 - 22) // new
    const uint8_t NFilter = 9; // Changed for Ben's Pack (39 - 47) // new


    uint16_t IndexCycLEDArray;
    const uint8_t   NUM_LEDS = 50; // Changed for Ben's Pack
