/****************************************************************************************
   ...
   Ben's Pinout Pin 2 - HGA - 0-6  Booster Tube - 7-22, Powercell - 23-38, N-Filter - 39-47, Cyclotron - 48-97
   ...
   Ben's Pinout Pin 3 - Top Flashing - 0, Top Rear - 1, Wand Vent - 2-8, Front Hat (Orange Hat) - 9, Top Front - 10, SloBlo (Back Red) - 11, Thrower - 12-18
...
const int NeoPixelLEDCountPack = 98;

// Wand LED Count - Changed for Ben's Pack
const int NeoPixelLEDCountWand = 19;
...
void PackLEDsComplete()
{
  ...
  else if (STATUS == POWERDOWN)
  {
    ...
    PackLEDs.ActivePatternCyc =  NONE;
...
void clearLEDs()
{
  ...
  //  }
  for (int i = 0; i <= NeoPixelLEDCountWand; i++) {
    wandLights.setPixelColor(i, 0);
  }
}
