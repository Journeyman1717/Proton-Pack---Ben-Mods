...
// NeoPattern Class - derived from the Adafruit_NeoPixel class // Defines the class
...
public:
  ...
  // Constructor - calls base-class constructor to initialize strip // Calls the constructor
